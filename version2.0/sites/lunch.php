  ...
  <div id="attributeInnerChange" class="bar">
    <div id="meal1" class="meal">
      <div class="meal-text">
        <?php
          if ($lang == 'eng') {
            echo "<h1 class='meal-name'>Green tea noodles with sticky sweet chilli salmon</h1>";
          } else if ($lang == 'de') {
            echo "<h1 class='meal-name'>Grüner Tee-Nudeln mit klebrig süßem Lachs</h1>";
          }
         ?>
      <?php
        if ($lang == 'eng') {
          echo "<p>This exotic style of making salmon is quite tasty and interesting. You won't regret trying it. It also is completely glutenfree and is perfect for Low Carb diets.</p>";
        } else if ($lang == 'de') {
          echo "<p>Dieser exotische Stil der Lachszubereitung ist sehr lecker ung interessant. Du würdest es nicht bereuen es zu probieren. Das Gericht ist auch glutenfrei und perfekt für Low Card Diäten</p>";
        }
       ?>
     </div>
     <div class="meal-img">
