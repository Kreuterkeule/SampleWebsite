       ...
       ?>
        ...
        <?php
          if ($lang == 'eng') {
            ...
            echo "<p>Grüner Tee-Nudeln mit klebrigem süßem Lachs</p>";
          }
         ?>
      </div>
      </a>
      ...
      if ($lang == 'eng') {
       ...
       <?php
         if ($lang == 'eng') {
           ...
           echo "<p>Silberrübenfett mit Sumachjoghurt und Kichererbsen</p>";
         }
        ?>
       ...
       ?>
        ...
        <?php
          if ($lang == 'eng') {
            ...
            echo "<p>Grüner Smoothie mit Avocado</p>";
          }
         ?>
      </div>
      </a>
      ...
      if ($lang == 'eng') {
       ...
       <?php
         if ($lang == 'eng') {
           ...
           echo "<p>Gesunder und Glutenfreier Schokoladenkeks</p>";
         }
        ?>
